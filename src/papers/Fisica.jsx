...
export const Fisica = () => {
  return (
    ...
    <h2 className="text-2xl text-white mb-4 font-regular">Física II</h2>
  ...
  <iframe width="470" height="836" src="https://www.youtube.com/embed/Wl0dmdOhiPI" title="Video Luvia" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
